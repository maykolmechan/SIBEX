        ...
        if ($avizo === '0') {
            ...
            $avizo ='<div class="alert alert-success" role="alert">
                        <div class="container">
                            ...
                            <strong>RESOLUCIÓN ACTUALIZADA CORRECTAMENTE.</strong>                            
                        </div>
                        <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                                <span aria-hidden="true"><i class="zmdi zmdi-close"></i></span>
                        </button>
            ...
            $avizo ='<div class="alert alert-success" role="alert">
                        <div class="container">
                            ...
                            <strong>RESOLUCIÓN NUEVA REGISTRADA CORRECTAMENTE.</strong>                            
                        </div>
                        <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                                <span aria-hidden="true"><i class="zmdi zmdi-close"></i></span>
                        </button>
            ...
            $avizo ='<div class="alert alert-success" role="alert">
                        <div class="container">
                            ...
                            <strong>RESOLUCIÓN ELIMINADA CORRECTAMENTE.</strong>                            
                        </div>
                        <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                                <span aria-hidden="true"><i class="zmdi zmdi-close"></i></span>
                        </button>
...
<meta name="description" content="SIBEX de Maykol Caicedo Mechán">
...
<link href="assets/js/jquery-3.4.1.min.js">
</head>
        ...
        <div class="block-header">
            <div class="row">
                ...
                <div class="col-lg-5 col-md-6 col-sm-12">
                    <a href="regresolucion.php" ><button class="btn btn-success btn-success float-right" type="button">NUEVA RESOLUCIÓN</button></a>
                </div>
            </div>
        </div>
            ...
            <div class="col-lg-12">
                ...
                ?>
                                <tr>                                    
                                    ...
                                    <td>
                                        <a class="single-user-name" ><?php echo $cons->anio.' <br>'.$cons->nfolio; ?></a><br>
                                    </td>                                         
                                    <td>
                                        <p><small><a class="single-user-name" ><?php echo $cons->nota; ?></a></small></p>
                                    </td>      
                                    <td>
                                        <center>
                                            <div class="buters-guide">                                                                  
                                                <a target="_blank" href="DOCS/RES/<?php echo $cons->linkarchivo; ?>"><img width='60' height='60' src="pdf-documento.png" alt="CLICK PARA ABRIR ARCHIVO" /></a>
                                            </div>
                                        </center>
                                        <?php echo substr($cons->freg, 0, 19); ?>
                                    </td>
                                    <td>
                                        <a href="../Vista/regresolucion.php?edit=1&res=<?php echo $cons->iddocumento; ?>" class="btn btn-default waves-effect waves-float btn-sm waves-green">
                                            <i class="zmdi zmdi-edit"></i></a>
                                            <a href="../Vista/php/rres.php?idr=<?php echo $cons->iddocumento; ?>" class="btn btn-default waves-effect waves-float btn-sm waves-red zonaelim">
